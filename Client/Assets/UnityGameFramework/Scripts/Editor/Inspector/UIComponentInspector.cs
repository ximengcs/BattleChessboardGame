...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class UIComponentInspector : GameFrameworkInspector
    {
        ...
        private SerializedProperty m_UIInstanceRoot = null;
        //private SerializedProperty m_SceneUIInstanceRoot = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                EditorGUILayout.PropertyField(m_UIInstanceRoot);
                //EditorGUILayout.PropertyField(m_SceneUIInstanceRoot);
        ...
        private void OnEnable()
        {
            ...
            m_UIInstanceRoot = serializedObject.FindProperty("m_UIInstanceRoot");
            //m_SceneUIInstanceRoot = serializedObject.FindProperty("m_SceneUIInstanceRoot");
