...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private Transform m_UIInstanceRoot = null;

        //[SerializeField]
        //private Transform m_SceneUIInstanceRoot = null;
        ...
        private void Start()
        {
            ...
            //if (m_SceneUIInstanceRoot == null)
            //{
            //    m_SceneUIInstanceRoot = new GameObject("UI Form Instances").transform;
            //    m_SceneUIInstanceRoot.SetParent(gameObject.transform);
            //    m_SceneUIInstanceRoot.localScale = Vector3.one;
            //}

            m_UIInstanceRoot.gameObject.layer = LayerMask.NameToLayer("UI");
            //m_SceneUIInstanceRoot.gameObject.layer = LayerMask.NameToLayer("UI");
        ...
        public bool AddUIGroup(string uiGroupName, int depth)
        {
            ...
            transform.SetParent(m_UIInstanceRoot);
            transform.localScale = Vector3.one;
        ...
        {
            return OpenUIForm(uiFormName, uiFormAssetName, uiGroupName, DefaultPriority, false, null);
        }
        ...
        {
            return OpenUIForm(uiFormName, uiFormAssetName, uiGroupName, DefaultPriority, pauseCoveredUIForm, null);
        }
        ...
        {
            return OpenUIForm(uiFormName, uiFormAssetName, uiGroupName, DefaultPriority, false, userData);
        }
        ...
        {
            return OpenUIForm(uiFormName, uiFormAssetName, uiGroupName, DefaultPriority, pauseCoveredUIForm, userData);
        }
        ...
        {
            return m_UIManager.OpenUIForm(uiFormName, uiFormAssetName, uiGroupName, priority, pauseCoveredUIForm, userData);
        }
