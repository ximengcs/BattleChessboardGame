...
public static class BinaryExtension
{
    ...
    public static Dictionary<int, int> ReadDictionary_2(this BinaryReader binaryReader)
    {
        return null;
    }

    public static List<Dictionary<int, int>> ReadList_1(this BinaryReader binaryReader)
    {
        return null;
    }
}
